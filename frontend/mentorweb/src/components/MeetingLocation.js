export default function MeetingLocation({isClassLocation, param, data }) {
    ...
    return (
        <div className={isClassLocation ? "w-2/3 m-auto": "w-full m-auto"}>
            <div className={isClassLocation ? "flex flex-col p-5 border border-light-gray rounded-md shadow-md mt-5":
            "w-3/4 flex flex-row p-5 border border-light-gray rounded-md shadow-md m-auto mt-5 justify-between"}>
                ...
                <div className={isClassLocation ? "flex flex-row items-center mb-2" : "flex flex-row items-center mb-1"}>
                    <label className={isClassLocation ? "whitespace-nowrap":"whitespace-nowrap ml-2"}>Location:</label>
                ...
                <div className={isClassLocation ? "flex flex-row items-center mb-2" : "flex flex-row items-center mb-1"}>
                    <label className={isClassLocation ? "whitespace-nowrap": "whitespace-nowrap"}>Virtual Meeting Link:</label>
                        <input className='border border-light-gray ml-2 w-40'
