...
- You have Python latest version (3.12.2) installed on your machine.
...
Below is a list of the libraries that you may need to install. For further help, consult Professor Kochanski.
